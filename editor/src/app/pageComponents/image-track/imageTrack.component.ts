...
const debug = require('debug')('piWriter/imageTrack.component.ts');

@Component({
    selector: 'app-image-track',
    templateUrl: './imageTrack.component.html',
    styleUrls: ['./imageTrack.component.css'],
    providers: [ConfigRepositoryService]
})
export class ImageTrackComponent implements OnInit {
    @Input() track: Track;
